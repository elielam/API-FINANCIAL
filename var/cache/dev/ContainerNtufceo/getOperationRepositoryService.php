...
// Returns the private 'App\Repository\OperationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OperationRepository.php';

return $this->services['App\Repository\OperationRepository'] = new \App\Repository\OperationRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
