...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoryRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\CategoryRepository']) ? $this->services['App\Repository\CategoryRepository'] : $this->load('getCategoryRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\OperationRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\OperationRepository']) ? $this->services['App\Repository\OperationRepository'] : $this->load('getOperationRepositoryService.php')) && false ?: '_'};
}))));
